...
magiskpolicy "dontaudit { hal_dms_default_exec vendor_file vendor_configs_file } labeledfs filesystem associate"
magiskpolicy "allow     { hal_dms_default_exec vendor_file vendor_configs_file } labeledfs filesystem associate"
...
magiskpolicy "dontaudit init { hal_dms_default_exec vendor_file vendor_configs_file } file relabelfrom"
magiskpolicy "allow     init { hal_dms_default_exec vendor_file vendor_configs_file } file relabelfrom"
